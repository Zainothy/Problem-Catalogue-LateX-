...
\author{Zain Sikand}
\title{A Series of Explorations in Maths, Physics and Philosophy}
...
\newglossaryentry{Combination-Problem}
{
name=The Combination Problem,
description={The metaphysical problem for panpsychism, concerning how tiny, fundamental units of conscious experience combine and link to create a coherent, unified consciousness that acts as a single entity.}
} 
\begin{document}
\begin{raggedright}
...
A collection of maths and physics problems, ranging in difficulty way beyond A-Level. These problems allow me to break down mu
  understanding of maths and physics fundamentally. Simultaneously, the book acts
  as a means to log and collect research regarding philosophy. 
%=============================================================================
\chapter{Mathematics}
%=============================================================================
\emph{Definition: Mathematics,}
\textbf{\say{The foundational means to which we, as a lost species amongst the
...
\[
  ...
  \qquad\Rightarrow\quad I_{4} = -\frac{1}{\sin^{2}x}.
\]
\[
...
\subsection{Exploring Connections to Physics} 
As previously mentioned, modern physical theory holds strong links with perceptions of consciousness and psychical precepts. A paper published by Gambini \footnote{\cite{gambini2025quantumpanprotopsychismconsciousnesscentereduniverse}} explores notions of 'panprotopsychism', the idea that the the non-physicalist approach holds validity- the intrinsic nature of the physical is purely 'experiential' such that classical physics breaks down when attempting to tackle \Gls{Combination-Problem} from this perspective. 
