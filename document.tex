...
\begin{raggedright}
    ...
    A collection of hellish maths and physics problems spawned from the depth of an erratic students hyperfixations, lacking logic or boundaries. This catalogue pushes the will of an A-Level student, and breaks down their understanding of maths and physics fundamentally. No form of revision or study at their age aids in the misery bestowed upon them via these problems, no trick or shortcut penetrates the difficulty of these problems. These problems, fundamentally, lack any consideration for the subject of their solving, lack consideration for creating a 'doable' problem, and lack any consideration for your sanity. 
    %Section 1: 
    \chapter{Mathematics}
