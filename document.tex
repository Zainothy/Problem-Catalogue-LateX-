...
%--- Visual Theme ------------------------------------------------------------
\definecolor{pcAccent}{HTML}{1F4E79}
\definecolor{pcAccentSoft}{HTML}{EDF3F8}
\definecolor{pcSecond}{HTML}{3E5C76}
\definecolor{pcMuted}{HTML}{5E6B78}
\definecolor{pcInk}{HTML}{111827}
...
\pretitle{\begin{center}\Huge\bfseries\color{pcAccent}}
\posttitle{\par\vspace{0.3em}{\color{pcAccentSoft}\rule{0.72\linewidth}{0.6pt}}\end{center}}
\preauthor{\begin{center}\large\color{pcMuted}}
\postauthor{\par\end{center}}
\predate{\begin{center}\normalsize\color{pcMuted}}
\postdate{\par\end{center}\vspace{0.8em}}

\titleformat{\part}[display]
  {\normalfont\huge\bfseries\color{pcAccent}}
  {\centering\color{pcMuted}\large PART \thepart}
  {0.5ex}
  {\centering}
  [\vspace{0.3ex}\centering\color{pcAccentSoft}\rule{0.38\linewidth}{0.6pt}]

\titleformat{\chapter}[display]
  {\normalfont\bfseries\color{pcInk}}
  {\filleft\color{pcAccent}\Large\thechapter}
  {0.6ex}
  {\LARGE}
  [\vspace{0.4ex}{\color{pcAccent}\titlerule}]
\titlespacing*{\chapter}{0pt}{-4pt}{14pt}

\titleformat{\section}
  {\normalfont\Large\bfseries\color{pcAccent}}
  {\thesection}{0.65em}{}
\titlespacing*{\section}{0pt}{10pt}{3pt}

\titleformat{\subsection}
  {\normalfont\large\bfseries\color{pcInk}}
  {\color{pcSecond}\thesubsection}{0.55em}{}
\titlespacing*{\subsection}{0pt}{7pt}{2pt}

\titleformat{\subsubsection}
  {\normalfont\normalsize\bfseries\itshape\color{pcMuted}}
  {\thesubsubsection}{0.5em}{}

\setlength{\headheight}{23pt}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize\color{pcMuted}\nouppercase{\rightmark}}
\fancyhead[R]{\footnotesize\color{pcMuted}Problem Catalogue}
\fancyfoot[C]{\color{pcMuted}\thepage}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\headrule}{\hbox to\headwidth{\color{pcAccentSoft}\leaders\hrule height 0.4pt\hfill}}
\renewcommand{\footrulewidth}{0pt}
\renewcommand{\chaptermark}[1]{\markboth{#1}{}}
\renewcommand{\sectionmark}[1]{\markright{#1}}
\newtcolorbox{cataloguebox}{
  colback=pcAccentSoft,
  colframe=pcAccent!45,
  boxrule=0.4pt,
  arc=2.2mm,
  left=1.2mm,right=1.2mm,top=0.9mm,bottom=0.9mm
}
\newcommand{\problemmeta}[1]{%
  \begin{cataloguebox}\textbf{\emph{#1}}\end{cataloguebox}%
}
...
\vspace*{\fill}
\begin{center}
  {\large\itshape A curated collection of mathematics, physics, and philosophy problems}
\end{center}
\vspace*{\fill}
\newpage
\tableofcontents
...
%=============================================================================
This catalogue is organised as a structured progression through mathematics,
physics, and philosophy. It combines Olympiad-style questions, modelling
problems, and reflective essays into one coherent reference.

\section*{How to Use This Catalogue}
\begin{cataloguebox}
  \begin{itemize}
    \item Each domain is grouped into its own part and chapter.
    \item Problems are arranged by topic and labelled consistently.
    \item Worked solutions appear immediately after the problem when included.
  \end{itemize}
\end{cataloguebox}
...
%=============================================================================
\chapter{Mathematics Problem Sets}
%=============================================================================
\emph{Definition: Mathematics,}
\textbf{The foundational means by which we, as a species among the cosmos,
  attempt to rationalise existence, model reality, and legitimise purpose.}
...
\problemmeta{Problem Author: Zain Sikand}
...
\newpage
\subsubsection{Worked Solution (Problem 1)}
...
\quad obtained by evaluating the bounds.
...
\[
  \begin{aligned}
    ...
    \Rightarrow\quad I_{4} & = -\frac{1}{\sin x}.
  \end{aligned}
\]
\[
...
\problemmeta{Modified Daily Integral: Evil}
...
\problemmeta{Problem Author: Carl Johan Malmsten --- 1842}
...
\problemmeta{Problem Author: Carter Owen}
...
\begin{center}
  \begin{tikzpicture}[scale=1, font=\small]
    ...
    % Intersection of the vertical line with the Dotenuse
...
\problemmeta{Moscow State University (1989)}
...
\problemmeta{IMO 2022}\hfill\textit{[Functional Equations]}
...
%=============================================================================
\chapter{Physics Problem Sets}
%=============================================================================
\emph{Definition: Physics,}
\textbf{The study of the laws governing matter, motion, energy, and space-time.}
...
\subsection{Problem 2}
\problemmeta{Problem Author: Zain Sikand}
A ball is thrown vertically upwards such that the angle at which it is thrown to the normal
,
\newpage
...
%=============================================================================
\chapter{Philosophical Essays and Notes}
%=============================================================================

\newpage

%-----------------------------------------------------------------------------
\section{Reflections on Infinity}
%-----------------------------------------------------------------------------

\subsection{Philisophical Perspectives on the limits of Human Knowledge}

In George Berkeley's \emph{Treatise Concerning the Principles of Human
  Knowledge}, one of the ideas explored is the limitation Human understanding, and that philosophers often err by claiming knowledge of concepts that exceed the capacities of finite minds; a consciousness that is finite is
incapable of comprehending that of the infinite. He, building on this arugment, goes on to reject Locke's notion of \say{\textbf{material substratum}}- abstract, mind-independent material substance- because we possess no cohesive idea of such a substance, and it's existence cannot be justified by experience.
He instead asserts that reality consists only of finite minds and infinite minds --- with God's boundless perception being the primary reason for the conceptualisation of the infinite.
...
of reality. This is seen in how he attacks the notion of \textbf{fluxions}, in \emph{The Analyst}, referring to them as the \say{\textit{ghosts of departed quantities}}- believing that the philosophical foundations to newtons calculus are flawed.
Moreover, we see that his perspective regarding such critiques the usage of abstraction for conceptualising the infinite. He attacks the notion of \say{\textit{infinitesimally small}} values, and enforces the idea that a conceptualisation must stem from real, perceived ideas as opposed to abstraction.

However, whilst Berkeley did oppose the usage of mathematical
abstraction in reasoning, he credited the need for a general way to quantify the infinite and acknowledged the practical usage of algebraic methods; but for Berkeley this was never the true means for percieving the infinite. His primary focus remained on the belief that true knowledge comes from perception, and as such, could not philosophically accept the conceptualisation of the purely theoretical infinite.
As such, mathematical concepts that dealt with the infinite were subject to this
belief- mathematics succeeds, not because it abstractly defines the infinite by attempting to reduce it to finite perception, but because it manipulates signs according to generally defined rules.

This belief coincides with Berkeley's theory on man's perception of reality- that which he cannot observe he cannot comprehend. To attempt to comprehend this is to defy the limitations of the finite mind provided by god in his infinite wisdom. Berkeley directly opposed the enlightenment, believing that progression had left behind our values and we had defied the limitations provided to us by god.
...
fill him with wonder and reverence.
Kant, in this conclusion of the critique, essentially draws attention to the
invisible self and its importance, shifting emphasis away from the merely
physical standing of man and toward the inward moral significance of conscious
life, rather than man's place in the external universe. Fundamentally, he
attempts to assert
...
\subsection{The Empirical Problem that Consciousness Imposes:}
Consciousness right now, even based off of these models is treated as a bi-product of matter; however the metaphysical perspective, that of which defies physicalism and materialism, defies this reduction of consciousness to a mere physical property that is innate in matter.
Instead it asserts irreducibility,doing so it suggests that any complete metaphysics of nature must account for subjectivity as a basic feature, whether that be fundamental or structural.
The notion of subjectivity in consciousness is supported by the fact that reductive methods of explaining conscious existence failed, as stated by Chalmers\footnote{\cite{10.1093/acprof:oso/9780195311105.003.0001}} in his work regarding consciousness.
Attempts from a quantitative perspective, that attempt to use mathematical or physical models also fail, as seen in work from an Iegor Reznikoff \footnote{\cite{reznikoff2021logicaltopologicalproofirreducibility}}- he attempts to use a mathematical approach to reduce conscious existence to objective physical data, proving that it fails.
As such, we have reason to believe that there is inherent subjectivity in conscious observation, which begs the question: \say{\textit{'Are current approaches sufficient in solving the mind-body provlem from a metaphysics perspective?'}}.
As philosophical approaches continue to argue that the materialist approach breaks down, the necessity of quantum mechanics in the problem starts to arise- is the lack of determinism in conscious existence evidence for quantum indeterminacy in consciousness, and does said indeterminacy require conscious observation to lie true?
\newpage
\subsection{The Cartesian Perspective:}
Descartes, as one of the foundational figures in Philosophical approaches to the mind-body problem in reference to human existence, acknowledged the systemic prescense of metaphysics as the groundwork for all progression of knowledge. He believed that, in order to progress said knowledge beyond the bounds of uncertainty, we must challenge Aristotle's natural philosphy: there is a way to immutably seperate the certain from the uncertain, that of which cannot draw generalisations and past experiences, hence rejecting Aristotle's approach.
\printbibliography
